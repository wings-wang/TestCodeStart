...
public class HelloWorldHandlerTest {
  ...
  /**
   * Initializing variables before we run the tests. Use @BeforeAll for initializing static variables at the start of
   * the test class execution. Use @BeforeEach for initializing variables before each test is run.
   */
  @BeforeAll
  static void setup() {
    // Use as needed.
  ...
  /**
   * De-initializing variables after we run the tests. Use @AfterAll for de-initializing static variables at the end of
   * the test class execution. Use @AfterEach for de-initializing variables at the end of each test.
   */
  @AfterAll
...
} // end class HelloWorldHandlerTest
